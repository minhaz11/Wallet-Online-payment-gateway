...
class WithdrawalController extends Controller
{
    ...
    public function details($id)
    {
        ...
        $pageTitle = $username.' Withdraw Requested ' . showAmount($withdrawal->amount) . ' '.$withdrawal->curr->currency_code;
    ...
    public function reject(Request $request)
    {
        ...
        if($withdraw->user_type == 'USER')           $user = User::find($withdraw->user_id);
        else if($withdraw->user_type == 'AGENT')     $user = Agent::find($withdraw->user_id);
        else if($withdraw->user_type == 'MERCHANT')  $user = Merchant::find($withdraw->user_id);
