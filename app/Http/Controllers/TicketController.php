...
class TicketController extends Controller
{
    ...
    public function supportTicket()
    {
        ...
        $supports = SupportTicket::where('user_id', userGuard()['user']->id)->where('user_type',userGuard()['type'])->orderBy('priority', 'desc')->orderBy('id','desc')->paginate(getPaginate());
        return view($this->activeTemplate . strtolower(userGuard()['type']).'.support.index', compact('supports', 'pageTitle'));
    }
    ...
    public function openSupportTicket()
    {
        ...
        $pageTitle = "Support Tickets";
        $user = userGuard()['user'];
        return view($this->activeTemplate . strtolower(userGuard()['type']).'.support.create', compact('pageTitle', 'user'));
    }
    ...
    public function storeSupportTicket(Request $request)
    {
        ...
        $ticket->user_type = userGuard()['type'];
    ...
    public function viewTicket($ticket)
    {
        ...
        $user = userGuard()['user'];
        if($user){
            $view = $this->activeTemplate. strtolower(userGuard()['type']).'.';
        } else {
            $view = $this->activeTemplate;
        }
        return view($view.'support.view', compact('my_ticket', 'messages', 'pageTitle', 'user'));
