                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="font-weight-bold">
                                <a href="{{  @$deposit->user->username ? route('admin.users.detail', $deposit->user_id) : route('admin.agent.detail', $deposit->user_id) }}">{{ @$deposit->user->username ?? $deposit->agent->username}}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
