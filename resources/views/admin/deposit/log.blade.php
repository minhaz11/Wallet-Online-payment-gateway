                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User')">
                                    <span class="font-weight-bold">{{ $deposit->user->fullname ?? $deposit->agent->fullname }}</span>
                                    <br>
                                    <span class="small">
                                    <a href="{{ @$deposit->user->username ? route('admin.users.detail', $deposit->user_id) : route('admin.agent.detail', $deposit->user_id)}}"><span>@</span>{{ $deposit->user->username ?? $deposit->agent->username }}</a>
                                    </span>
                                </td>
