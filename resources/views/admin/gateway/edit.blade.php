                                        ...
                                        <div class="card border--primary mt-2">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    <label class="w-100">@lang('Minimum Amount') <span class="text-danger">*</span></label>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text min-cur"></div>
                                                    </div>
                                                ...
                                                <div class="input-group">
                                                    <label class="w-100">@lang('Maximum Amount') <span class="text-danger">*</span></label>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text max-cur"></div>
                                                    </div>
                                        ...
                                        <div class="card border--primary mt-2">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    <label class="w-100">@lang('Fixed Charge') <span class="text-danger">*</span></label>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text charge-cur"></div>
                                                    </div>
    ...
    <script>
        (function ($) {
            ...
            $('.newCurrencyBtn').on('click', function () {
                ...
                $('.charge-cur').text(getCurrencySelected);
                $('.min-cur').text(getCurrencySelected);
                $('.max-cur').text(getCurrencySelected);
                form.find('.currencyText ').val(currency);
