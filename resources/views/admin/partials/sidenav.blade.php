    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard')}}" class="sidebar__main-logo"><img
                    src="{{getImage(imagePath()['logoIcon']['path'] .'/light_logo.png')}}" alt="@lang('image')"></a>
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                <li class="sidebar__menu-header">@lang('Main')</li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.currencies')}}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.profit.logs*',3)}}">
                        <i class="menu-icon las la-file-invoice-dollar"></i>
                        <span class="menu-title">@lang('Profit Logs')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.profit.logs*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.profit.logs.all')}} ">
                                <a href="{{route('admin.profit.logs.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Logs')</span>
                                    
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.profit.logs')}} ">
                                <a href="{{route('admin.profit.logs')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Only Profits')</span>
                                    
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.profit.logs.commission')}} ">
                                <a href="{{route('admin.profit.logs.commission')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.agent*',3)}}">
                        ...
                        @if($banned_agent_count > 0 || $email_unverified_agent_count > 0 || $sms_unverified_agent_count > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.agent*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.agent.all')}} ">
                                <a href="{{route('admin.agent.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Agents')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.agent.active')}} ">
                                <a href="{{route('admin.agent.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.agent.banned')}} ">
                                <a href="{{route('admin.agent.banned')}}" class="nav-link">
                                    ...
                                    @if($banned_agent_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$banned_agent_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.agent.email.unverified')}}">
                                <a href="{{route('admin.agent.email.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>

                                    @if($email_unverified_agent_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$email_unverified_agent_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.agent.sms.unverified')}}">
                                <a href="{{route('admin.agent.sms.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('SMS Unverified')</span>
                                    @if($sms_unverified_agent_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$sms_unverified_agent_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.agent.email.all')}}">
                                <a href="{{route('admin.agent.email.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email to All')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.merchant*',3)}}">
                        <i class="menu-icon las la-user-tie"></i>
                        <span class="menu-title">@lang('Manage Merchants')</span>
                        
                        @if($banned_merchant_count > 0 || $email_unverified_merchant_count > 0 || $sms_unverified_merchant_count > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.merchant*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.merchant.all')}} ">
                                <a href="{{route('admin.merchant.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Merchant')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.merchant.active')}} ">
                                <a href="{{route('admin.merchant.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Merchant')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.merchant.banned')}} ">
                                <a href="{{route('admin.merchant.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Merchant')</span>
                                    @if($banned_merchant_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$banned_merchant_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.merchant.email.unverified')}}">
                                <a href="{{route('admin.merchant.email.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>

                                    @if($email_unverified_merchant_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$email_unverified_merchant_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.merchant.sms.unverified')}}">
                                <a href="{{route('admin.merchant.sms.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('SMS Unverified')</span>
                                    @if($sms_unverified_merchant_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$sms_unverified_merchant_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.merchant.email.all')}}">
                                <a href="{{route('admin.merchant.email.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email to All')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.manage.kyc*')}} ">
                    <a href="{{route('admin.manage.kyc')}}" class="nav-link">
                        <i class="menu-icon lab la-wpforms"></i>
                        <span class="menu-title">@lang('Manage KYC Form')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.kyc.info*',3)}}">
                        <i class="menu-icon lab la-korvue"></i>
                        <span class="menu-title">@lang('Manage KYC Info')</span>
                        
                        @if($pending_user_kyc > 0 || $pending_agent_kyc > 0 || $pending_merchant_kyc > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.kyc.info*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.kyc.info.user.pending','admin.kyc.info.user.approved','admin.kyc.info.user.details'])}} ">
                                <a href="{{route('admin.kyc.info.user.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Users KYC')</span>
                                    @if($pending_user_kyc > 0)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$pending_user_kyc}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive(['admin.kyc.info.agent.pending','admin.kyc.info.agent.approved','admin.kyc.info.agent.details'])}} ">
                                <a href="{{route('admin.kyc.info.agent.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Agents KYC')</span>
                                    @if($pending_agent_kyc > 0)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$pending_agent_kyc}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive(['admin.kyc.info.merchant.pending','admin.kyc.info.merchant.approved','admin.kyc.info.merchant.details'])}} ">
                                <a href="{{route('admin.kyc.info.merchant.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Merchant KYC')</span>
                                    @if($pending_merchant_kyc > 0)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$pending_merchant_kyc}}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.qr.template')}}">
                    <a href="{{route('admin.qr.template')}}" class="nav-link">
