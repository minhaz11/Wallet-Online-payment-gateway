...
<div class="row justify-content-center">
    @if(request()->routeIs('admin.withdraw.log') || request()->routeIs('admin.withdraw.method') || request()->routeIs('admin.users.withdrawals') || request()->routeIs('admin.users.withdrawals.method') ||request()->routeIs('admin.agent.withdrawals') || request()->routeIs('admin.agent.withdrawals.method') ||request()->routeIs('admin.merchant.withdrawals') || request()->routeIs('admin.merchant.withdrawals.method'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User Type')">
                                    <span class="font-weight-bold">{{ $withdraw->user_type }}</span>
                                   
                                </td>
                                <td data-label="@lang('User')">
                                    @if ($withdraw->user_type == 'USER')
                                    <span class="font-weight-bold">{{ $withdraw->user->fullname }}</span><br>
                                    <span class="small"> <a href="{{ route('admin.users.detail', $withdraw->user_id) }}"><span>@</span>{{ $withdraw->user->username }}</a> </span>
                                    @elseif($withdraw->user_type == 'AGENT')
                                    <span class="font-weight-bold">{{ $withdraw->agent->fullname }}</span><br>
                                    <span class="small"> <a href="{{ route('admin.users.detail', $withdraw->user_id) }}"><span>@</span>{{ $withdraw->agent->username }}</a> </span>
                                    @else
                                    <span class="font-weight-bold">{{ $withdraw->merchant->fullname }}</span><br>
                                    <span class="small"> <a href="{{ route('admin.users.detail', $withdraw->user_id) }}"><span>@</span>{{ $withdraw->merchant->username }}</a> </span>
                                    @endif
                                ...
                                <td data-label="@lang('Conversion')">
                                   1 {{ __($withdraw->curr->currency_code) }} =  {{ showAmount($withdraw->curr->rate) }} {{ __($general->cur_text) }}
                                    <br>
                                    <strong>{{ showAmount($withdraw->final_amount) }} {{ __($withdraw->curr->currency_code) }}</strong>
                                </td>
...
@push('breadcrumb-plugins')
    ...
    @if(!request()->routeIs('admin.users.withdrawals') && !request()->routeIs('admin.users.withdrawals.method') && !request()->routeIs('admin.agent.withdrawals') && !request()->routeIs('admin.agent.withdrawals.method') && !request()->routeIs('admin.merchant.withdrawals') && !request()->routeIs('admin.merchant.withdrawals.method'))
