    ...
    <div id="invoice" class="effect2">
      ...
      <div id="invoice-mid">
        ...
        <div id="project" style="text-align: right;">
          ...
          <h3>{{showAmount($invoice->total_amount,2)}} {{$invoice->currency->currency_code}}</h3>
      ...
      <div id="invoice-bot">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr class="service">
                ...
                <td class="tableitem" style="text-align: right; padding-right:10px;"><p class="itemtext">{{$invoice->currency->currency_symbol}}{{showAmount($item->amount)}} {{$invoice->currency->currency_code}}</p></td>
              </tr>
              @endforeach
              <tr class="tabletitle">
                <td></td>
                <td class="Rate" style="text-align: right;"><h2>@lang('Total')</h2></td>
                <td class="payment"><h2>{{$invoice->currency->currency_symbol}}{{showAmount($invoice->total_amount)}} {{$invoice->currency->currency_code}}</h2></td>
              </tr>
        ...
        <div class="pay-btn-wrapper">
          <a href="{{route('invoice.payment.confirm',$invoiceNum)}}" class="btn">@lang('Pay Now')</a>
        </div>
        @endif
