    ...
    <div class="sidebar-menu-wrapper" id="sidebar-menu-wrapper">
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu__item {{menuActive('agent.withdraw.money')}}">
                <a href="{{route('agent.withdraw.money')}}" class="sidebar-menu__link">
                    <i class="las la-university"></i>
                    @lang('Withdraw Money')
                </a>
            </li>
            <li class="sidebar-menu__item {{menuActive('agent.withdraw.methods')}}">
                <a href="{{route('agent.withdraw.methods')}}" class="sidebar-menu__link">
