<div class="d-sidebar h-100 rounded">
    ...
    <div class="sidebar-menu-wrapper" id="sidebar-menu-wrapper">
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu__item {{menuActive('merchant.withdraw.money')}}">
                <a href="{{route('merchant.withdraw.money')}}" class="sidebar-menu__link">
                    <i class="las la-university"></i>
                    @lang('Withdraw Money')
                </a>
            </li>
            <li class="sidebar-menu__item {{menuActive('merchant.withdraw.methods')}}">
                <a href="{{route('merchant.withdraw.methods')}}" class="sidebar-menu__link">
