    ...
    <div class="header__bottom">
      <div class="container">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          <a class="site-logo site-title" href="{{route('home')}}"><img src="{{ getImage(imagePath()['logoIcon']['path'] .'/light_logo.png') }}" alt="logo"></a>
          ...
          <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu ms-auto">
              ...
              <li class="menu_has_children"><a href="#0">@lang('Transfer')</a>
                <ul class="sub-menu">
                  <li><a href="{{route('user.transfer')}}">@lang('Transfer Money')</a></li>
