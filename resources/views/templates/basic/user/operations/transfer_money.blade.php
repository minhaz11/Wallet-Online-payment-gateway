                ...
                <div class="col-lg-8">
                    <form action="" method="POST" id="form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <select class="select style--two currency" name="wallet_id"  required>
                                                ...
                                                <option value="{{$wallet->id}}" data-code="{{$wallet->currency->currency_code}}" data-rate="{{$wallet->currency->rate}}" data-type="{{$wallet->currency->currency_type}}" {{request('wallet') == $wallet->currency->currency_code ?'selected':''}}>{{$wallet->currency->currency_code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        <div class="col-lg-6 form-group">
                                            ...
                                            <input type="text" class="form--control style--two amount" name="amount" disabled placeholder="0.00" required value="{{old('amount')}}">
                                            <label> 
                                                <span class="text--warning min">@lang('Min: '){{getAmount($transferCharge->min_limit)}} {{defaultCurrency()}} --</span>
                                                <span class="text--warning max">@lang('Max: '){{getAmount($transferCharge->max_limit)}} {{defaultCurrency()}}</span>
                                             </label>
                                        </div>
                                        <div class="col-lg-6 form-group">
                        ...
                        <div class="text-center">
                            <button type="button" class="btn btn-md btn--base mt-4 transfer">@lang('Transfer Now')</button>
                        </div>
