                ...
                <div class="col-lg-8">
                    <form action="" method="POST" id="form">
                                ...
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label class="mb-0">@lang('Voucher Code')<span class="text--danger">*</span> </label>
                                            <input type="number" class="form--control style--two code" name="code" placeholder="@lang('Place voucher code here')" required value="{{old('code')}}">
                                        </div>
                                    </div><!-- row end -->
                                </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-md btn--base mt-4 req_confirm">@lang('Redeem')</button>
                        </div>
                    </form>
                </div>
            </div>
